                  ...
                  <div class="bg-gray-50 px-4 py-3 text-right sm:px-6">
                      <button type="submit" @submit.prevent="handleLogin"
                          class="
                                inline-flex
                                justify-center
                                rounded-md border border-transparent bg-green-100 py-2 px-4">Continue</button>
                  ...
                  <div>
                      <input
                          ...
                          class="mt-1
                                 ...
                                 px-3 py-2
                                 rounded-md
                                 border border-gray-300 shadow-sm focus:border-black focus:outline-none">
                  </div>
              </div>
              <div class="bg-gray-50 px-4 py-3 text-right sm:px-6">
                  <button type="submit" @submit.prevent="handleVerification"
                          class="inline-flex
                                 ...
                                 hover:bg-gray-600
                                 focus:outline-none">Verify</button>
              </div>
          </div>
      </form>
  </div>
...
/**Handle the use if he / she has login in*/
onMounted(() =>{
...
const  getFormattedCredentials = () =>{
    return{
        phone: credentials.phone.replaceAll(' ', '').replace('(', '').replace(')', '').replace('-', ''), // change to regex,
